        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((svc) => (
              <div
                key={svc.id}
                className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-400 border border-gray-100 flex flex-col"
              >
                {/* Tag */}
                <div className="relative">
                  <span
                    className={`absolute top-3 left-3 z-10 ${svc.tagColor} text-white text-[10px] font-bold px-2.5 py-1 rounded-full`}
                  >
                    {svc.tag}
                  </span>
